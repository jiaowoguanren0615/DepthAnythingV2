...
from models.build_dptV2 import dptv2_vits, dptv2_vitb, dptv2_vitl, dptv2_vitg

from datasets import build_dataset

from util import distributed_utils as utils
...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'DPTV2 training and evaluation script', add_help=False)
    ...
    parser.add_argument("--image_size", type=int, default=518, help="input size")
    parser.add_argument("--ignore_label", type=int, default=255, help="the datasets ignore_label")
    parser.add_argument("--ignore_index", type=int, default=255, help="the datasets ignore_index")
    ...
    # Model parameters
    parser.add_argument('--model', default='dptv2_vits', type=str, metavar='MODEL',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'DPTV2 training and evaluation script', parents=[get_args_parser()])
